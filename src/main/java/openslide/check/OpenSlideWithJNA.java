...
public final class OpenSlideWithJNA implements Closeable {
    private static final FileFilter FILE_FILTER = new FileFilter() {
        @Override
        public boolean accept(File f) {
            return f.isDirectory() || OpenSlideWithJNA.detectVendor(f) != null;
        }
    ...
    final private Map<String, AssociatedImageJNA> associatedImages;
    ...
    public OpenSlideWithJNA(File file) throws IOException {
        if (!file.exists()) {
...
//            long h = OpenSlideJNA.INSTANCE.openslide_get_level_height(osr, i);
    ...
    public Map<String, AssociatedImageJNA> getAssociatedImages() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OpenSlideWithJNA) {
            OpenSlideWithJNA os2 = (OpenSlideWithJNA) obj;
    ...
    public interface OpenSlideJNA extends Library {
        ...
        // pointers to container variables should be long[], or sigsegv
